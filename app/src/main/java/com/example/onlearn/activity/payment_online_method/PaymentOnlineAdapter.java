...
public class PaymentOnlineAdapter extends RecyclerView.Adapter<PaymentOnlineAdapter.KHUNGNHIN> {
    Context context;
    ...
    public PaymentOnlineAdapter(Context context, ArrayList<Items_CART> dulieu) {
    ...
    @Override
    public PaymentOnlineAdapter.KHUNGNHIN onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_1dong_itemcart, null);
        return new PaymentOnlineAdapter.KHUNGNHIN(view);
    }


    @Override
    public void onBindViewHolder(@NonNull PaymentOnlineAdapter.KHUNGNHIN holder, int position) {
